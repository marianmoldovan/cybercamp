...
public final class AdRecord implements Parcelable {
	...
	public static final Parcelable.Creator<uk.co.alt236.bluetoothlelib.device.adrecord.AdRecord> CREATOR = new Parcelable.Creator<uk.co.alt236.bluetoothlelib.device.adrecord.AdRecord>() {
		public uk.co.alt236.bluetoothlelib.device.adrecord.AdRecord createFromParcel(Parcel in) {
			return new uk.co.alt236.bluetoothlelib.device.adrecord.AdRecord(in);
		}

		public uk.co.alt236.bluetoothlelib.device.adrecord.AdRecord[] newArray(int size) {
			return new uk.co.alt236.bluetoothlelib.device.adrecord.AdRecord[size];
		}
	};
