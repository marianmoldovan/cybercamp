...
public class BluetoothLeDevice implements Parcelable {
	...
	public static final Parcelable.Creator<uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice> CREATOR = new Parcelable.Creator<uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice>() {
		public uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice createFromParcel(Parcel in) {
			return new uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice(in);
		}

		public uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice[] newArray(int size) {
			return new uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice[size];
		}
	};
	 ...
	 */
	public BluetoothLeDevice(uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice device) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice other = (uk.co.alt236.bluetoothlelib.device.BluetoothLeDevice) obj;
