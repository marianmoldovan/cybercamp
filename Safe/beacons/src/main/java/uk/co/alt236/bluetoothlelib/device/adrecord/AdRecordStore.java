...
public class AdRecordStore implements Parcelable {
	...
	public static final Parcelable.Creator<uk.co.alt236.bluetoothlelib.device.adrecord.AdRecordStore> CREATOR = new Parcelable.Creator<uk.co.alt236.bluetoothlelib.device.adrecord.AdRecordStore>() {
		public uk.co.alt236.bluetoothlelib.device.adrecord.AdRecordStore createFromParcel(Parcel in) {
			return new uk.co.alt236.bluetoothlelib.device.adrecord.AdRecordStore(in);
		}

		public uk.co.alt236.bluetoothlelib.device.adrecord.AdRecordStore[] newArray(int size) {
			return new uk.co.alt236.bluetoothlelib.device.adrecord.AdRecordStore[size];
		}
	};
